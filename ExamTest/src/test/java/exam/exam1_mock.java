...
public class exam1_mock extends EasyMockSupport {
   exam1 exam1Mock;
    ...
    public  void setUp() throws Exception {
      exam1Mock=partialMockBuilder(exam1.class).addMockedMethods("oneHalf", "getRestZero").createMock();
    }
    ...
    public void examMockTest() {
        ...
        replayAll();
        assertEquals(1,exam1.oneHalf(2));
        assertFalse(exam1.getRestZero(2, 1));
        verifyAll();
    }
